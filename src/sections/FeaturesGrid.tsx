  ...
  return (
    <section className="py-24 overflow-x-clip">
      <div className="container">
        <div className="flex flex-col gap-40 md:gap-48 lg:gap-80">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl text-zinc-400 mt-8 lg:text-2xl">
                BlockNova provides robust and secure infrastructure to support
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-col text-xl text-zinc-400 mt-6 gap-6 lg:text-2xl">
                <p>
                  BlockNova is dedicated to supporting the evolution of Web3
                  applications by delivering the necessary infrastructure and
                  security for Web3.
                </p>
                <p>
                  BlockNova champtions Web3 for everyone. As a decentralized
                  blockchain scaling platform, BlockNova enables developers to
