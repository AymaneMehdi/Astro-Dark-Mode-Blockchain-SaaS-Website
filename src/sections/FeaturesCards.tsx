...
const cardData = [
  ...
  },
  {
    ...
    title: "Seamless Blockchain Integraion",
    description:
...
export const FeaturesCardsSection = () => {
  ...
  return (
    <section className="py-24 overflow-x-clip md:-mt-20 ">
          ...
          <div className="flex flex-none gap-8">
            {cardData.map(({ image, title, description, color }, cardIndex) => (
              ...
              >
                ...
                <div
                  className={twMerge(
                    "absolute size-16 rounded-xl bg-fuchsia-500 top-1.5 right-1.5 -z-10",
                ...
                <div
                  className={twMerge(
                    "absolute size-16 rounded-xl bg-fuchsia-500 top-1.5 right-1.5 -z-10 blur-lg opacity-0 group-hover:opacity-100 group-hover:bg-fuchsia-300 transition duration-300",
                    color === "lime" && "bg-lime-500 group-hover:bg-lime-500",
                    color === "cyan" && "bg-cyan-500 group-hover:bg-cyan-500",
                    color === "violet" &&
                      "bg-violet-500 group-hover:bg-violet-500",
                  )}
                ></div>
                <div
                  className="
            absolute inset-0 bg-zinc-800 -z-10 rounded-2xl
            [mask-image:linear-gradient(225deg,transparent,transparent_40px,black_40px)]
          "
                ></div>
                <div className="flex justify-center -mt-28">
                  <div className="inline-flex relative">
                    <div className="absolute h-4 w-full top-[calc(100%+16px)] bg-zinc-950/70 rounded-[100%] group-hover:bg-zinc-950/30 transition duration-1000 [mask-image:radial-gradient(closest-side,black,transparent)]"></div>
                    <img
                      src={image}
                      alt="Pill image"
