    ...
    <section className="py-24 md:py-52 overflow-x-clip">
      <div className="container">
        ...
        <p className="text-center text-xl mt-6 text-zinc-400 md:text-2xl max-w-xl mx-auto">
          BlockNova is pioneering smart contract integrity with cutting-edge
          data solutions.
        </p>
        ...
        <div className="flex justify-center flex-col mt-40 md:mt-80 items-center gap-4">
