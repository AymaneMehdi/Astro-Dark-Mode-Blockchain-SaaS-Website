...
export const CutCornerButton = (props: ComponentPropsWithoutRef<"button">) => {
  ...
  return (
    <div>
      ...
      >
        <div className="absolute inset-0 outline outline-2 -outline-offset-2 outline-fuchsia-500 [mask-image:linear-gradient(225deg,_transparent_0,_transparent_10px,_black_10px,_black_100%)]"></div>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
